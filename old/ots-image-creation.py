...
def make_ots_subject_images(sub, df, out_parc_path, out_curv_path, jitter=True, make_curv=True):
    if jitter:
        angles = make_angles()
    else:
        angles = [[210.0, 90.0]]
...
make_ots_subject_images(sub, df_filtered, out_parc_path=out_parc_dir, out_curv_path=out_curv_dir)
